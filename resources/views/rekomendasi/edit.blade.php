...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Edit Rekomendasi Menu</h1>
        ...
        <div class="card shadow mb-4">
            ...
            <form action="{{ route('rekomendasi.update', $rekomendasi->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="judul_menu" id="judul_menu" class="form-control @error('judul_menu') is-invalid @enderror" value="{{ old('judul_menu',$rekomendasi->judul_menu) }}">
                    @error('judul_menu')
                ...
                <div class="form-group">
                    ...
                    <textarea name="langkah" id="langkah" cols="30" rows="5" class="form-control @error('langkah') is-invalid @enderror">
                        {{ old('langkah',$rekomendasi->langkah) }}
                    </textarea>
                    @error('langkah')
                        <div class="invalid-feedback">
                            {{ $message }}
                ...
                <div class="form-group">
                    ...
                    @if ($rekomendasi->gambar != null)
                      <br><img src="{{ asset($rekomendasi->gambar) }}" alt="{{ $rekomendasi->judul_menu}}" class="rounded img-fluid" width="200px" height="200px"><br><br>
                    @endif
